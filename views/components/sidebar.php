<aside
    class="sidenav navbar navbar-vertical navbar-expand-xs border-0 shadow border-radius-xl my-3 fixed-start ms-3 bg-white text-dark"
    id="sidenav-main">

    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            aria-hidden="true" id="iconSidenav"></i>
        <a class="navbar-brand m-0" href="/Citycargo/modulos/index.php">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-4 ">
                <a class="nav-link  " href="/Citycargo/modulos/mantenimiento.php">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  " href="/Citycargo/modulos/inventario.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard"
                        target="_blank" class="btn btn-white btn-sm w-100 mb-0">Docum</a>
                </div>
            </div>
        </div>
