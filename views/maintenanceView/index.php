                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xs text-secondary mb-0">WYC123</p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">Propietario</p>
                                            <!-- <p class="text-xs text-secondary mb-0">Organization</p> -->
                                        ...
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">22/04/18</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span class="text-xs font-weight-bold mb-0">Despinchada</span>
                                        </td>
                                        <td class="align-middle">
                                            <a href="javascript:;" class="text-secondary font-weight-bold text-xs"
                                                data-toggle="tooltip" data-original-title="Edit user">
