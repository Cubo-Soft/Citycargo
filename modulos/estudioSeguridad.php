...
<head>
    ...
    <script src="../js/js_estudioSeguridad.js?n=<?= rand() ?>" type="text/javascript"></script>
...
<body>
    <div>
        ...
        <table class="table table-borderless table-striped">
            <tr>
                <td colspan="4" style="text-align: center;"><img src="../imagenes/logocity.jpg" alt="Logo CITYCARGO" style="width:30em;" /></td>
            </tr>
            <tr>
                <td colspan="2"><strong>PLAN ESTRATEGICO DE SEGURIDAD VIAL</strong></td>
                <td colspan="2"><strong>FORMATO ESTUDIO DE SEGURIDAD VEHÍCULO</strong></td>
            </tr>
            <tr style="background-color: #20de59;">
                <td colspan="4" class="text-center align-middle"><strong>ESTUDIO DE SEGURIDAD</strong></td>
            </tr>
...
retornarDivsParaImagenes($arreglo,1);
?>
                </td>
                <td>
            ...
            <tr>
                    ...
                    <div>
                        ...
                        <div id="divForm1">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="file" name="imagen1" id="imagen1" accept=".jpg, .jpeg, .png">
                                <input type="submit" value="Actualizar" name="submit" id="btnImg1" class="btn btn-success">
                            </form>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <div id="divForm2">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="file" name="imagen2" id="imagen2" accept=".jpg, .jpeg, .png">
                                <input type="submit" value="Actualizar" name="submit" id="btnImg2" class="btn btn-success">
                            </form>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <div id="divForm3">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="file" name="imagen3" id="imagen3" accept=".jpg, .jpeg, .png">
                                <input type="submit" value="Actualizar" name="submit" id="btnImg3" class="btn btn-success">
                            </form>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <div id="divForm4">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="file" name="imagen4" id="imagen4" accept=".jpg, .jpeg, .png">
                                <input type="submit" value="Actualizar" name="submit" id="btnImg4" class="btn btn-success">
                            </form>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="divLicenciaConduccion">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="file" name="licenciaconductor" id="licenciaconductor" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                            <input type="submit" value="Actualizar" name="submit" id="btnFile2" class="btn btn-success">
                        </form>
                    </div>
                </td>
                ...
                <td>
                    ...
                    <div id="divLicenciaConduccion2">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="file" name="licenciaconductor2" id="licenciaconductor2" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                            <input type="submit" value="Actualizar" name="submit" id="btnFile8" class="btn btn-success">
                        </form>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <div id="divFormFotoConductor">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="file" name="fotoconductor" id="fotoconductor" accept=".jpg, .jpeg, .png">
                                <input type="submit" value="Actualizar" name="submit" id="btnImg5" class="btn btn-success">
                            </form>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    ...
                    <div id="divFormHojaVidaConductor">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="file" name="hojavidacond" id="hojavidacond" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                            <input type="submit" value="Actualizar" name="submit" id="btnFile1" class="btn btn-success">
                        </form>
                    </div>
                </td>
            </tr>            
...
?>
            ...
            <tr>
                <td style="background-color: #9dc3e6;"><strong>Autorización de manejo <br />de datos personales</strong></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="divFormDatPerPropietario">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="file" name="rutadatperprop" id="rutadatperprop" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                            <input type="submit" value="Actualizar" name="submit" id="btnFile4" class="btn btn-success">
                        </form>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="divFormCertBancPropietario">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="file" name="rutacertbanprop" id="rutacertbanprop" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                            <input type="submit" value="Actualizar" name="submit" id="btnFile6" class="btn btn-success">
                        </form>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="divFormRUTPropietario">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="file" name="rutarutprop" id="rutarutprop" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                            <input type="submit" value="Actualizar" name="submit" id="btnFile5" class="btn btn-success">
                        </form>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="divFormRUNTPropietario">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="file" name="rutaruntprop" id="rutaruntprop" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                            <input type="submit" value="Actualizar" name="submit" id="btnFile3" class="btn btn-success">
                        </form>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="divFormRUTDocumento">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="file" name="rutarutltc" id="rutarutltc" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                            <input type="submit" value="Actualizar" name="submit" id="btnFile7" class="btn btn-success">
                        </form>
                    </div>
                </td>
            </tr>
                ...
                <td>
                    <div>
                        ...
                        <div id="divFormPlacaTrailer">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="file" name="imagen5" id="imagen5" accept=".jpg, .jpeg, .png">
                                <input type="submit" value="Actualizar" name="submit" id="btnImg6" class="btn btn-success">
                            </form>
                        </div>
                    </div>
                </td>
