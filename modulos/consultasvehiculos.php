...
if (is_null($_SESSION["rol_id"])) {
    ...
    <html>
        <head>
            ...
            <title>Consultas veh&iacute;culos</title>
            ...
            <script src="../js/js_consultasVehiculos.js?n=<?= rand(0, 3) ?>" type="text/javascript"></script>             
                ...
                <div id="contenedor">
                    <div id="contenedor-index" class="row input-sm">                       
                        ...
                        <div id="texoDocumento" class="col-sm-4 input-sm">
                            <h1>Consultas veh&iacute;culos</h1>
                        </div>                                        
                        ...
                        <div class="panel-body">
                            <div class='col-lg-12' >
                                ...
                                <table class="table table-hover" >
                                    ...
                                    <tbody>                                                                                
                                        <tr><td>Calificaci&oacute;n por placa</td><td><?= $placa; ?></td><td></td><td></td><td></td><td></td></tr> 
                                        <tr><td>Veh&iacute;culos por:</td><td>Tipo:<?= retornarListaVehiculos(); ?></td><td>Carroceria:<?= retornarListaCarrocerias() ?></td><td>Capacidad inicial<input type="number" id="capacidadInicial" name="capacidadInicial" class="form-control" value="0" /></td><td>Capacidad final<input type="number" id="capacidadFinal" name="capacidadFinal" class="form-control" value="0" /></td><td><br><input type="button" id="consultarVehiculo" name="consultarVehiculo" class="form-control" value="Consultar" /></td></tr>
                                    </tbody>
                                </table>                                
                            </div>                                                       
