            ...
            <form method="post" action="../trafico/redirigir.php" name="formuarlio_index" >
                <div id="contenedor">
                    <div id="contenedor-index" class="col-lg-12 row input-sm">                       
                        <div id="divImagenUsa" class="col-lg-4 input-sm"><img class="col-lg-12" src="../imagenes/logocity.jpg" alt="CITYCARGO" id="imagen_usapostal_cotizacion"/></div>
                    ...
                    <div id="contenedor-index2" class="col-lg-12 panel panel-success">                        
                        <div class="panel-body">
                            <div class="col-lg-12">                                
                                ...
                                ?>                                                      
                                <button name="boton" id="botonSalir" type="submit" class="btn btn-secondary btn-lg botonIndex" onmouseenter="colorIndexEntra(this);" onmouseleave="colorIndexSale(this);" value="SALIR"> SALIR </button>                                                                
                            </div>  
                        </div>        
                        <div class="col-lg-12" >                            
                            <?php
                           ...
                           <div class="alert alert-success col-lg-<?= $collg ?>" id="DivPorRevisar">
                            ...
                            <div class="alert alert-success col-lg-<?= $collg ?>" id="DivPorPagar">
                                Servicios por pagar:
                                <a class="btn btn-success btn-sm"  id="porPagar" href="../modulos/anticiposPendientes.php" target="_blank">
                                    <strong>
                                        <?= $cantidadAnticipos ?>
                                    </strong>
                                </a>
                            ...
                            if ($_SESSION["departamento"] === 'GERENCIA' || $_SESSION["departamento"] === 'SISTEMAS') {
                                ...
                                <div class="alert alert-success col-lg-<?= $collg ?>" id="DivConNovedad">
                                    ...
                                    <a class='btn btn-success btn-sm' id='porCancelar' href='../modulos/serviciosporcancelar.php?novedad=1' target="_blank">
                                        <strong>
